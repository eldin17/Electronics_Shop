...
class NoWishlistScreen extends StatelessWidget {
  final Product? productObj;
  NoWishlistScreen({super.key, this.productObj});
          ...
          child: Column(
            children: [
              ...
              ErrorInfo(
                ...
                description:
                    "Looks like you don't have a wishlist yet.\nLet’s kickstart your journey by adding your first tech desires.",
                btnText: "Create My Wishlist",
                press: () async {
                  var wishlistObj = await _wishlistProvider
                      .add({'customerId': LoginResponse.currentCustomer!.id});

                  LoginResponse.currentCustomer?.wishlist = wishlistObj;
