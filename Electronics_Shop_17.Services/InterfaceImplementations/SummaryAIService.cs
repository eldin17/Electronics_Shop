...
namespace Electronics_Shop_17.Services.InterfaceImplementations
{
    public class SummaryAIService : ISummaryAIService
    {
        ...
        private async Task<string> GenerateSummaryFromLlmAsync(List<string> reviews)
        {
            ...
            history.AddSystemMessage("You are an assistant that summarizes product reviews for an e-commerce store. Be concise, objective, and highlight the main pros and cons based *only* on the provided text. Keep responses short, maximum 5 bulletpoints.");
