...
namespace Electronics_Shop_17.Services.Database
{
    public class Phone : IHelperId
    {
        ...
        public int MainCameraResolution_MP { get; set; } // Main camera resolution, e.g., "50 MP"
        public int FrontCameraResolution_MP { get; set; } // Front camera resolution, e.g., "12 MP"
        ...
        public decimal Weight { get; set; } // Weight in grams, e.g., 180
